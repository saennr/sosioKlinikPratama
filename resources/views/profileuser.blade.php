    ...
    <div class="profile-container">
        ...
        <form action="{{ route('profileUpdate') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="first-name" name="first_name" value="{{ old('firstName', $user->firstName) }}" required>
            </div>
            <div class="form-group">
                <label for="last-name">Last Name</label>
                <input type="text" id="last-name" name="last_name" value="{{ old('lastName', $user->lastName) }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="phone" name="phone" value="{{ old('phone', $user->no_hp) }}" required>
            </div>
            <div class="form-group">
                <label for="birth-date">Tanggal Lahir</label>
                <input type="date" id="birth-date" name="birth_date" value="{{ old('birth_date', $user->tgl_lahir ? \Carbon\Carbon::parse($user->tgl_lahir)->format('Y-m-d') : '') }}" required>
            </div>
